  ...
  List<Ride> _generateMockRides() {
    ...
    return [
      ...
      Ride(
        ...
        driverRating: null,
        userRating: null,
        cancellationReason: 'Driver was late',
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'From: ${ride.pickupLocation?.address ?? 'Pickup location'}',
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'To: ${ride.dropoffLocation?.address ?? 'Dropoff location'}',
                      style: const TextStyle(fontSize: 14),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
              ...
              Row(
                children: [
                  Icon(
                    isCompleted ? Icons.star : Icons.info_outline,
                    size: 16,
                    color: AppColors.textSecondary,
                  ),
                  const SizedBox(width: 8),
                  Text(
                    isCompleted
                        ? 'Rating: ${ride.userRating?.toStringAsFixed(1) ?? 'N/A'}'
                        : isCancelled
                        ? 'Cancelled: ${ride.cancellationReason ?? 'N/A'}'
